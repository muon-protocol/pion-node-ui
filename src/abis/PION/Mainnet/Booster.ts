export default [
  {
    inputs: [
      ...
      { internalType: 'uint256', name: '_boostValue', type: 'uint256' },
      {
        internalType: 'address',
        name: '_signer',
        type: 'address',
  ...
  },
  {
    inputs: [
      ...
      { internalType: 'uint256', name: 'signedPrice', type: 'uint256' },
      {
        internalType: 'uint256',
        name: 'timestamp',
        type: 'uint256',
  ...
  {
    inputs: [
      { internalType: 'uint256', name: '_newValidityPeriod', type: 'uint256' },
    ],
  ...
  {
    inputs: [
      { internalType: 'uint256', name: 'chainAmount', type: 'uint256' },
      {
        internalType: 'uint256',
        name: 'oracleAmount',
        type: 'uint256',
