export default [
  ...
  {
    inputs: [{ internalType: 'uint64[]', name: '_nodeId', type: 'uint64[]' }],
    name: 'exitBatch',
    outputs: [],
    stateMutability: 'nonpayable',
    type: 'function',
  ...
  {
    inputs: [
      { internalType: 'uint64', name: '_lastNodeId', type: 'uint64' },
      {
        internalType: 'uint256',
  ...
  {
    inputs: [
      { internalType: 'uint64[]', name: '_nodeId', type: 'uint64[]' },
      {
        internalType: 'address[]',
        name: '_nodeAddress',
        type: 'address[]',
      },
      { internalType: 'address[]', name: '_stakerAddress', type: 'address[]' },
      {
        internalType: 'string[]',
        name: '_peerId',
        type: 'string[]',
