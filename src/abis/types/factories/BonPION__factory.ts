...
import type { BonPION, BonPIONInterface } from "../BonPION";
...
export class BonPION__factory {
  static readonly abi = _abi;
  static createInterface(): BonPIONInterface {
    return new utils.Interface(_abi) as BonPIONInterface;
  }
  static connect(
    address: string,
    signerOrProvider: Signer | Provider
  ): BonPION {
    return new Contract(address, _abi, signerOrProvider) as BonPION;
  }
}
