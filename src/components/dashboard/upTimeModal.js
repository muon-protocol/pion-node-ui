...
export default function UpTimesModal() {
  ...
  return (
    <>
      ...
      <div
        data-te-modal-init
        class="fixed left-0 top-0 z-[1055] hidden h-full max-h-[600px] w-full overflow-y-auto overflow-x-hidden outline-none"
      ...
      >
        ...
        >
          <div class="pointer-events-auto relative flex w-full flex-col rounded-[18px] border-none bg-white bg-clip-padding text-current shadow-lg outline-none dark:bg-neutral-600">
            ...
            <div class="relative py-4 px-8 flex justify-between">
              <p>Join at</p>
              ...
              <div class="rounded-[18px]  border border-neutral-200 bg-white dark:border-neutral-600 dark:bg-neutral-800">
                ...
                >
                  <div class="px-5 py-4 max-h-[300px] overflow-y-auto">
                    {selector.downNodeTimes.map((downTime) => (
                      <p>{downTime}</p>
                    ))}
                  </div>
                </div>
