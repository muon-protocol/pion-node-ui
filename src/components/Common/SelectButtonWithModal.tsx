  ...
  return (
    <div className="select-button-with-modal mb-2">
      <div className="flex flex-col w-full gap-2" onClick={onClick}>
        ...
        <div
          className="select-button-with-modal__button flex items-center justify-between bg-catskill-white rounded-xl pl-3 md:pl-5 pr-4 h-12 md:h-14 cursor-pointer">
              ...
              <>
                {selectedItems.length > 0 ? (
                  selectedItems.map((selectedItem) => (
                    <span
                      className="rounded-lg bg-algo px-2 md:px-3 py-2 flex gap-2 md:gap-3 items-center justify-between">
                  ...
                  <p className="text-gray font-medium max-md:text-sm">
                    Select
                  </p>
                )}
              </>
